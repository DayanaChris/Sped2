...
<body >
    ...
    <form class="" action="questionnaires_menu" method="get">
                          ...
                          <div class="row">
                            @foreach($questionnaires as $questionnaire)
                                <div class="col-md-4">
                                  ...
                                  <button name="category_id" value="{{$questionnaire->questionnaire_id}}" id="{{$questionnaire->questionnaire_id}}" style="background: transparent; border: none">
