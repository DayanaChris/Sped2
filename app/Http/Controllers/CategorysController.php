...
class CategorysController extends Controller
{
  ...
  public function __construct()
     ...
     */
     ...
     {
       // $categorys = "SELECT category_name FROM `categorys` WHERE category_name = 'ALPHABETS'";
       // return view('category_menu')->with('categorys', $categorys);

       $categorys =DB::select( DB::raw("SELECT category_name FROM
         `categorys` WHERE category_name = 'ALPHABETS'"));
      return view('category_menu')->with('categorys',$categorys);
    ...
    {
      $categorys =DB::select( DB::raw("SELECT * FROM
        `categorys`WHERE category_name = 'ACTION WORDS'"));
     return view('category_menu')->with('categorys',$categorys);
    }
    public function colors()
    {
      $categorys =DB::select( DB::raw("SELECT * FROM
        `categorys`WHERE category_name = 'COLORS'"));
     return view('category_menu')->with('categorys',$categorys);
    }
    public function numbers()
    {
      $categorys =DB::select( DB::raw("SELECT * FROM
        `categorys`WHERE category_name = 'NUMBERS'"));
     return view('category_menu')->with('categorys',$categorys);
    }
