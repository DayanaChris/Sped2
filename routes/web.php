...
Route::get('/category_menu', 'CategorysController@alpha');
Route::get('/category_menu', 'CategorysController@colors');

Route::get('/category_menu', 'CategorysController@numbers');

Route::get('/category_menu', 'CategorysController@actionwords');
